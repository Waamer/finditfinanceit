...
const DropZoneArea = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
...
const DropzoneFileList = forwardRef<HTMLOListElement, React.OlHTMLAttributes<HTMLOListElement>>(
  (props, ref) => {
    const context = useDropzoneContext();
    if (!context) {
...
const DropzoneMessage = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  (props, ref) => {
    const { children, ...rest } = props;
    const context = useDropzoneContext();
    if (!context) {
...
const DropzoneTrigger = forwardRef<HTMLLabelElement, React.LabelHTMLAttributes<HTMLLabelElement>>(
